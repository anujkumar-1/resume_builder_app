...
const resumeArr = ["summary", "experience", "skills", "education", "certification", "awards", "languages"]
...
window.addEventListener("DOMContentLoaded", async (e) => {
    ...
    const user= await axios.get(`${NETWORK_URL}/resume/getResumeInfo`, {headers: {Authorization: token}})
...
function updateExperienceInfoResume(response){
    if( response.length!=0){
        ...
        skillsSection.insertAdjacentHTML('beforend', sectionTemplates.experience);
...
async function updateContactInfo() {
    ...
    const response = await axios.post(`${NETWORK_URL}/resume/updateContactInfo`, obj, { headers: { Authorization: token } })
...
async function updateExperience() {
    ...
    const token = localStorage.getItem("token")
    const response = await axios.post(`${NETWORK_URL}/resume/updateExperience`, obj, {headers: {Authorization:token}})
...
async function updateSkills() {
    ...
    const response =  await axios.post(`${NETWORK_URL}/resume/updateSkills`, obj, {headers:{Authorization:token}})
}
...
async function updateEducation() {
    ...
    const response = await axios.post(`${NETWORK_URL}/resume/updateEducation`, obj, {headers:{Authorization:token}})
}
...
async function updateSummary() {
    ...
    const response = await axios.post(`${NETWORK_URL}/resume/updateSummary`, obj, {headers:{Authorization:token}})
...
async function updateLanguages() {
    ...
    const response = await axios.post(`${NETWORK_URL}/resume/updateLanguages`, obj, {headers:{Authorization:token}})
}
...
async function updateCertificates() {
    ...
    const response = await axios.post(`${NETWORK_URL}/resume/updateCertificates`, obj, {headers:{Authorization:token}})
}
...
async function updateAwards() {
    ...
    const response = await axios.post(`${NETWORK_URL}/resume/updateAwards`, obj, {headers:{Authorization:token}})
}
...
async function updateIntrest(){
    ...
    const response = await axios.post(`${NETWORK_URL}/resume/updateIntrest`, obj, {headers:{Authorization:token}})
}
...
async function updateProjects(){
    ...
    const token = localStorage.getItem("token")
    const response = await axios.post(`${NETWORK_URL}/resume/updateProject`, obj, {headers: {Authorization:token}})
}
  ...
  async function updateEditExperience(e){
    ...
    const response = await axios.post(`${NETWORK_URL}/resume/updateEditExperience`, obj, {headers: {Authorization:token}})
...
async function updateEditEducation(e){
    ...
    const response = await axios.post(`${NETWORK_URL}/resume/updateEditEducation`, obj, {headers: {Authorization:token}})
...
async function downloadResume() {
    try {
        const token = localStorage.getItem("token")
        const resume = await axios.get(`${NETWORK_URL}/resume/downloadResume`, {headers:{Authorization: token}})
    } catch (error) {
    }
